...
Thank you for considering to contribute to Ingot.


Setup for development
-----------------------

-   Fork Ingot to your GitHub account.
-   `Clone`_ the Ingot repository locally.

    .. code-block:: text

        $ git clone https://github.com/crazytruth/ingot
        $ cd ingot
...
-   Add your fork as a remote to push your work to. Replace
    ...
    .. code-block:: text
        ...
        git remote add fork https://github.com/{username}/ingot
...
-   Create a virtualenv with `pyenv`_ and `pyenv-virtualenv`_.
    ...
    .. code-block:: bash
        ...
        $ pyenv virtualenv {pythonversion} ingot
        $ pyenv local ingot

-   Install Ingot in editable mode with development dependencies.
...
.. _Fork: https://github.com/crazytruth/ingot/fork
